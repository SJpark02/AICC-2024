...
def split_wav(source_directory, target_directory, split_length=600000):  # split_length는 밀리초 단위
    # 저장할 경로가 존재하지 않으면 생성
...
# 원본 파일이 있는 폴더 경로
source_directory_path = "your path"

# 분할된 파일을 저장할 폴더 경로
target_directory_path = "your path"
